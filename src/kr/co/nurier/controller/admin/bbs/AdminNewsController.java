package kr.co.nurier.controller.admin.bbs;
...
public class AdminNewsController {
    ...
    @RequestMapping("/admin/news.nurier")
    ...
    @RequestMapping("/admin/news/{postId}.nurier")
     ...
     * @throws Exception 
     */
    @Value("#{adminJspMap['admin0002']}") String admin0002;
    @RequestMapping("/admin/news/insert.nurier")
